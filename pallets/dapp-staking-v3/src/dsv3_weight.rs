...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: DappStaking ContractStake (max_values: None, max_size: Some(93), added: 2568, mode: MaxEncodedLen)
	...
	fn dapp_tier_assignment(x: u32, ) -> Weight {
		...
		//  Measured:  `449 + x * (33 ±0)`
		//  Estimated: `3558 + x * (2568 ±0)`
		// Minimum execution time: 9_000_000 picoseconds.
		Weight::from_parts(15_553_205, 3558)
			// Standard Error: 9_476
			.saturating_add(Weight::from_parts(2_714_919, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
			.saturating_add(Weight::from_parts(0, 2568).saturating_mul(x.into()))
	}
}
