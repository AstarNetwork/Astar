...
pub use plasm_executor::NativeExecutor;
		...
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, plasm_runtime::RuntimeApi, _>(
						client.clone(), &*client, select_chain
					)?;

				let import_queue = aura::import_queue::<_, _, aura_primitives::sr25519::AuthorityPair, _>(
											  ...
											  -> Result<impl AbstractService, ServiceError>
{
	...
	ServiceBuilder::new_light::<Block, RuntimeApi, plasm_executor::Executor>(config)?
		.with_select_chain(|_config, backend| {
