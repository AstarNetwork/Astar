...
/// to even the srml datastructures.
pub mod opaque {
	use super::*;
	...
	impl_opaque_keys! {
		pub struct UncheckedExtrinsicSessionKeys {
...
pub type UncheckedExtrinsicHandleReport = generic::UncheckedExtrinsic<Address, Call, Signature, SignedExtra>;
