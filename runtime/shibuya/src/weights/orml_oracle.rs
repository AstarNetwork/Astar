...
// --heap-pages=4096
// --output=./benchmark-results/shibuya-dev/oracle_weights.rs
...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_347_052, 0)
			.saturating_add(Weight::from_parts(0, 8634))
			// Standard Error: 50_689
			.saturating_add(Weight::from_parts(12_834_329, 0).saturating_mul(x.into()))
