...
// --heap-pages=4096
// --output=./benchmark-results/shibuya/runtime/oracle_weights.rs
...
impl<T: frame_system::Config> orml_oracle::WeightInfo for SubstrateWeight<T> {
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_293_172, 0)
			.saturating_add(Weight::from_parts(0, 8634))
			// Standard Error: 64_988
			.saturating_add(Weight::from_parts(16_404_825, 0).saturating_mul(x.into()))
