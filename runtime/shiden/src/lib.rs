...
use frame_support::{
    ...
    traits::{
        Contains, Currency, FindAuthor, Get, Imbalance, OnRuntimeUpgrade, OnUnbalanced, EnsureOneOf,
        EqualPrivilegeOnly, ConstU128,
    },
    weights::{
...
impl pallet_collective::Config<CouncilCollective> for Runtime {
	...
	type WeightInfo = pallet_collective::weights::SubstrateWeight<Runtime>; // TODO: use weights module
}
...
impl pallet_democracy::Config for Runtime {
	...
	type PreimageByteDeposit = ConstU128<{ deposit(0, 1) }>; // TODO: decide preimage byte deposit fee
	type Slash = ();
	type Scheduler = Scheduler;
	type MaxVotes = MaxVotes;
	type OperationalPreimageOrigin = pallet_collective::EnsureMember<AccountId, CouncilCollective>;
	type PalletsOrigin = OriginCaller;
	type WeightInfo = pallet_democracy::weights::SubstrateWeight<Runtime>; // TODO: use weights module
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        // reserve 70~ for contracts pallet
