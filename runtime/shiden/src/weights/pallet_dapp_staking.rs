...
// --heap-pages=4096
// --output=./runtime/shiden/src/weights/pallet_dapp_staking.rs
...
impl<T: frame_system::Config> pallet_dapp_staking::WeightInfo for WeightInfo<T> {
	...
	fn claim_unlocked(x: u32, ) -> Weight {
		...
		Weight::from_parts(36_358_331, 4764)
			// Standard Error: 4_211
			.saturating_add(Weight::from_parts(62_190, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DappStaking::Ledger` (r:1 w:1)
	...
	fn claim_staker_rewards_past_period(x: u32, ) -> Weight {
		...
		Weight::from_parts(52_950_094, 4764)
			// Standard Error: 21_184
			.saturating_add(Weight::from_parts(2_293_504, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn claim_staker_rewards_ongoing_period(x: u32, ) -> Weight {
		...
		//  Estimated: `4764`
		// Minimum execution time: 48_000_000 picoseconds.
		Weight::from_parts(49_807_579, 4764)
			// Standard Error: 12_831
			.saturating_add(Weight::from_parts(2_448_431, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: `DappStaking::StakerInfo` (r:1 w:1)
	...
	fn claim_bonus_reward() -> Weight {
		...
		Weight::from_parts(41_000_000, 3775)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: `DappStaking::IntegratedDApps` (r:1 w:0)
	...
	fn claim_dapp_reward() -> Weight {
		...
		Weight::from_parts(62_000_000, 5113)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `DappStaking::IntegratedDApps` (r:1 w:0)
	...
	fn cleanup_expired_entries(x: u32, ) -> Weight {
		...
		// Minimum execution time: 38_000_000 picoseconds.
		Weight::from_parts(38_006_958, 4764)
			// Standard Error: 28_316
			.saturating_add(Weight::from_parts(6_146_015, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn move_stake_from_registered_source() -> Weight {
		...
		Weight::from_parts(89_000_000, 6296)
	...
	fn move_stake_unregistered_source() -> Weight {
		...
		Weight::from_parts(79_000_000, 6296)
	...
	fn on_initialize_voting_to_build_and_earn() -> Weight {
		...
		//  Estimated: `4254`
		// Minimum execution time: 35_000_000 picoseconds.
		Weight::from_parts(40_000_000, 4254)
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `DappStaking::CurrentEraInfo` (r:1 w:1)
	...
	fn on_initialize_build_and_earn_to_voting() -> Weight {
		...
		Weight::from_parts(54_000_000, 4254)
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().writes(7))
	}
	/// Storage: `DappStaking::CurrentEraInfo` (r:1 w:1)
	...
	fn dapp_tier_assignment(x: u32, ) -> Weight {
		...
		// Minimum execution time: 6_000_000 picoseconds.
		Weight::from_parts(6_507_503, 3061)
			// Standard Error: 7_916
			.saturating_add(Weight::from_parts(3_180_381, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
