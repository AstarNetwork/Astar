...
// --heap-pages=4096
// --output=./runtime/shiden/src/weights/orml_oracle.rs
...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_253_038, 8634)
			// Standard Error: 55_073
			.saturating_add(Weight::from_parts(12_686_464, 0).saturating_mul(x.into()))
