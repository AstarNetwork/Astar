...
// --heap-pages=4096
// --output=./benchmark-results/astar/runtime/oracle_weights.rs
...
impl<T: frame_system::Config> orml_oracle::WeightInfo for SubstrateWeight<T> {
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_245_764, 0)
			.saturating_add(Weight::from_parts(0, 8634))
			// Standard Error: 62_942
			.saturating_add(Weight::from_parts(16_419_329, 0).saturating_mul(x.into()))
